...
object KChatLogger {
    ...
    fun registerLoggers(loggers: Collection<Logger>) {
        synchronized(KChatLogger.loggers) {
            KChatLogger.loggers.addAll(loggers)
        }
    }
    ...
    fun unregisterLoggers(loggers: Collection<Logger>) {
        synchronized(KChatLogger.loggers) {
            KChatLogger.loggers.removeAll(loggers)
        }
    }
    ...
    @JvmStatic
    fun tag(explicit: String): KChatLogger {
        explicitTag.set(explicit)
        return this
    }

    @JvmStatic
    fun properties(values: Map<String, String>): KChatLogger {
        properties.set(values.toMap())
        return this
    }

    @JvmStatic
    fun properties(vararg values: Pair<String, String>): KChatLogger {
